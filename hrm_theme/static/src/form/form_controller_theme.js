...
// // import { LayoutTheme } from "@vitech_real_estate_theme/search/layout_theme";
...
// // -----------------------------------------------------------------------------
//
// export class FormControllerTheme extends FormController {
//     setup() {
//         super.setup();
...
//         onst succeeded = await this.model.root.urgentSave();
//         if (!succeeded) {
//             ev.preventDefault();
...
// }
//
// FormControllerTheme.template = `vitech.theme.FormView`;
// FormControllerTheme.components = {
//     FormStatusIndicator,
//     Layout,
//     ButtonBox,
//     ViewButton,
...
// };
// FormControllerTheme.defaultProps = {
//     preventCreate: false,
//     preventEdit: false,
// };
