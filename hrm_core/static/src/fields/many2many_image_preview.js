...
export class Many2ManyImagePreview extends Many2ManyBinaryField {
    static template = "vitech_real_estate_core.Many2ManyImagePreview";
    ...
    onFileCamera = (ev) => {
        ...
        this.dialogService.add(CameraDialog, {parent: this, onUpload: (files) => this.onFileUploaded(files)},);
    }
    ...
    get files() {
        return this.props.record.data[this.props.name].records.map((record) => {
            ...
            return Object.assign(new AttachmentModel(), {
                ...record.data, id: record.resId, modelOwner: record.data.model_owner,
            })
    ...
    getImageUrl(attachment) {
        ...
        return url(attachment.urlRoute, {
            ...attachment.urlQueryParams, width: this.imagesWidth, height: this.imagesHeight,
        });
    }
    ...
    onClickUnlink(attachment) {
        this.dialogService.add(ConfirmationDialog, {
            body: _t('Do you really want to delete "%s"?', attachment.name), cancel: () => {
...
export const many2ManyImagePreviewField = {
    ...many2ManyBinaryField, component: Many2ManyImagePreview,
    relatedFields: [
        ...many2ManyBinaryField.relatedFields,
    ],
};

registry.category("fields").add("many2many_image_preview", many2ManyImagePreviewField);
