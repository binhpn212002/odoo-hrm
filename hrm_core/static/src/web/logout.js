...
export function VitechItem(env) {
    return {
        type: "item",
        id: "settings",
    ...
    return {
        ...
        callback: async function () {
            ...
            if (modalElement.length) {
                ...
                console.error("Modal element with ID 'remove_account_modal' not found.");
            }
        },
        sequence: 51,
    };
...
registry
    .category("user_menuitems")
    .add("log_out", VitechLogout)
registry
    .category("user_menuitems")
    .add("profile", VitechItem)
registry
    .category("user_menuitems")
    .add("remove_account", removeUser)
